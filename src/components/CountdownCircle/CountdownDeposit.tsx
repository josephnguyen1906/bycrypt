import { getCheck, getCheckDeposit } from "@/services/User.service";
...
export const CountdownDeposit: React.FC<CircleCountdownProps> = ({
  radius = 60,
  duration,
  id,
  onComplete,
  ...
  const fetchStatus = useCallback(async () => {
    if (!id) return;
    try {
      const res: any = await getCheckDeposit(id);
