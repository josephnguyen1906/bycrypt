    ...
    item: [
      {
        ...
        link: "#",
        title: "Giao dịch P2P",
        note: "Mua Bán Không mất phí giao dịch thông qua hơn 100 phương thức thanh toán",
        icon: <P2PMenuIcon />,
      },
    ],
  },
  ...
  },
  {
    ...
    item: [
      ...
      },
      {
        id: "4",
        link: "#",
        title: "Chương trình nhà mua giới",
        note: "Mua Bán Không mất phí giao dịch thông qua hơn 100 phương thức thanh toán",
        icon: <P2PMenuIcon />,
      },
      {
        id: "5",
        link: "#",
        title: "Tài khoản giao dịch phụ được quản lý",
        note: "Mua Bán Không mất phí giao dịch thông qua hơn 100 phương thức thanh toán",
        icon: <P2PMenuIcon />,
      },
      {
        id: "6",
        link: "#",
        title: "Dữ liệu thị trường gần đây",
        note: "Mua Bán Không mất phí giao dịch thông qua hơn 100 phương thức thanh toán",
        icon: <P2PMenuIcon />,
      },
      {
        id: "7",
        link: "#",
        title: "Thông tin chuyên sâu về tổ chức",
        note: "Mua Bán Không mất phí giao dịch thông qua hơn 100 phương thức thanh toán",
        icon: <P2PMenuIcon />,
      },
    ],
